...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 9), // void()(double *, double *, int, int, double, int, double *)
...
static void _cffi_d_DP(double * x0, double * x1, int x2, int x3, double x4, int x5, double * x6)
{
  DP(x0, x1, x2, x3, x4, x5, x6);
}
#ifndef PYPY_VERSION
static PyObject *
_cffi_f_DP(PyObject *self, PyObject *args)
{
  ...
  if (!PyArg_UnpackTuple(args, "DP", 7, 7, &arg0, &arg1, &arg2, &arg3, &arg4, &arg5, &arg6))
    return NULL;
...
#else
#  define _cffi_f_DP _cffi_d_DP
#endif

static const struct _cffi_global_s _cffi_globals[] = {
  { "DP", (void *)_cffi_f_DP, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_V, 0), (void *)_cffi_d_DP },
};
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__DP(const void *p[])
{
...
PyInit__DP(void)
{
  return _cffi_init("_DP", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_DP(void)
{
  _cffi_init("_DP", 0x2601, &_cffi_type_context);
}
#endif
